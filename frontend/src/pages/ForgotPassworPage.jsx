...
import { useSendResetPasswordLinkMutation } from "../redux/features/authApi";
...
function ForgotPassworPage() {
    ...
    const handleSubmit = async ()=>{
        ...
        setSubmitted(true);
        const result = await sendResetPasswordLink(sendEmail);
			...
			<div className='p-8'>
				...
				{!isSubmitted ? (
					...
					<div className='text-center'>
                        ...
                        <Link to={`/reset-password/${resetToken}`} className="text-blue-600">Go to reset page</Link>
